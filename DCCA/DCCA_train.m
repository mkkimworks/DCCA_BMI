...
if exist('DCCA_results') == 0
    mkdir('DCCA_results');
end
filename=['./DCCA_results0320/result_K=' num2str(K) ...
  '_rcov1=' num2str(rcov1) ...
  '_rcov2=' num2str(rcov2) ...
  '_l2penalty=' num2str(l2penalty) ...
  '_batchsize=' num2str(batchsize) ...
  '_eta0=' num2str(eta0) ...
  '_decay=' num2str(decay) ...
  '_momentum=' num2str(momentum) ...
  '_maxepoch=' num2str(maxepoch) ...
  '_numlayer=' num2str(length(NN1)-1) ...
  '_numnodes=' num2str(NN1(1)) ...
